...
(function() {
    // Load image preview.
	var root = '/coopcardio/admin/libs/ckeditor';
    var IMAGE = 1,
		LINK = 2,
		PREVIEW = 4,
		CLEANUP = 8,
        ...
        return {
            ...
            contents: [
				...
				{	
				    id: 'Upload',
				    hidden: false,
				    filebrowser: { action : 'QuickUpload', target : 'info:txtUrl', url:'teste' },
				    label: 'Arquivos Online',
				    'for': ['info', 'txtUrl'],
				    elements:
					[
						{
						    type: 'html',
						    id: 'htmlUpload',
						    html: '<iframe id="ifrFileMan" style="background-color: #FFFFFF;" onload="this.style.width=\'100%\'; this.style.height=\'300px\';" src="'+root+'/custom/?editor=image" width="100%" height="600px"></iframe>'
		                }
					]
				}
				*/
