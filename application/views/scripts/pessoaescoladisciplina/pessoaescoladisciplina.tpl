...
<center>
	<div class="body">
		<div class="innerBody">
			<form id="form" name="form" method="post" action="javascript: enviarForm('{php}print BASE_URL;{/php}/pessoaescoladisciplina/PessoaEscolaDisciplina', 'form', 'save');" onsubmit="return(runAction(this))">
